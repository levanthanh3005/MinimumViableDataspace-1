...
class FieldValueConstraintTest {
    ...
    private static final String HEADQUARTER_ADDRESS_PATH = "selfDescriptionCredential.credentialSubject.gx-participant:headquarterAddress.gx-participant:country.@value";
